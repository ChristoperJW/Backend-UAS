    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-lg border border-gray-100 p-8">
        ...
        <form action="/register" method="POST" class="flex flex-col gap-5">
            ...
            <div>
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700 bg-gray-50 transition-all" placeholder="Konfirmasi kata sandi" required>
            </div>
